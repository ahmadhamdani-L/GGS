          ...
          boxShadow: [
            BoxShadow(
              color: Color.lerp(
                ...
                const Color(0xFFFF4444).withOpacity( ),
                _ctrl.value,
              )!,
...
class _ShieldDomePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final sparkPaint = Paint()..color = Colors.white.withOpacity( );
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final fillPaint = Paint()
      ..shader = RadialGradient(
        colors: [
          const Color(0xFFDDD6FE).withOpacity( ),
...
class _ConfettiPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (final p in pieces) {
      ...
      final paint = Paint()..color = p.color.withOpacity( ).clamp(0.3, 1.0));
