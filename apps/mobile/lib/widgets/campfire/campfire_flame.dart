...
class _FlamePainter extends CustomPainter {
    ...
    final groundGlow = Paint()
      ..shader = RadialGradient(
        colors: [
          ...
          const Color(0xFFFF4500).withValues(alpha: ),
          Colors.transparent,
        ],
  ...
  void _drawFlameBody(Canvas canvas, double cx, double baseY, double flameH, double w) {
    ...
    final corePaint = Paint()
      ..shader = RadialGradient(
        colors: [
          const Color(0xFFFFFFE0).withValues(alpha: ),
  ...
  void _drawEmbers(Canvas canvas, double cx, double baseY, double flameH, double w) {
    for (final e in embers) {
      ...
      final emberPaint = Paint()
        ..color = const Color(0xFFFF8C00).withValues(alpha: )
      ...
      canvas.drawCircle(
        Offset(ex, ey),
        1.0,
        Paint()..color = const Color(0xFFFFD700).withValues(alpha: ),
      );
    }
  }
