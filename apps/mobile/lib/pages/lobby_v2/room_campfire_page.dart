      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(bottom: BorderSide(color: Colors.white.withOpacity( ))),
          ),
          child: Row(
            children: [
              // Exit
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: const Color(0xFFDAA520).withOpacity( ),
                  border: Border.all(color: const Color(0xFFDAA520).withOpacity( )),
                ),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: enabled
                          ? LinearGradient(colors: [color.withOpacity( ), color.withOpacity( )])
                          : null,
                      color: enabled ? null : Colors.white.withOpacity( ),
                      border: Border.all(color: color.withOpacity( )),
                    ),
                    child: Center(
                      child: Text(label,
      ...
      child: BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border(top: BorderSide(color: Colors.white.withOpacity( ))),
          ),
          child: Column(
            children: [
              // Messages
              Expanded(
                child: messages.isEmpty
                    ? Center(child: Text('💬 Chat', style: TextStyle(color: Colors.white.withOpacity( ), fontSize: 12)))
                    : ListView.builder(
